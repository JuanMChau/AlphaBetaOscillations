function h = plotpval(ax, xpos, ypos, pval, color, pexact,pname,minp,plotline,numonly,minifz,fz)
% h = plotpval(ax, xpos, ypos, pval, color, pexact,pname,minp,plotline,numonly,minifz,fz)
